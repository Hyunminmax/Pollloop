...
class CustomUser(AbstractUser):
    ...
    # 추가 필드
    name = models.CharField(max_length=100, blank=True, verbose_name="이름")  # 사용자 이름 추가     #삭제 필요
    profile = models.CharField(max_length=255, blank=True, verbose_name="프로필")  # 사용자 프로필 추가
    age = models.IntegerField(blank=True, null=True, verbose_name="나이")  # 나이 필드 추가     #삭제 필요
